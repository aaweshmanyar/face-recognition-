...
img = cv.imread(r'C:\python\opencv\face_recognization\Images\Robert Downey\Robert.jpg')
...
for(x,y,w,h) in face_rect:
    ...
    cv.putText(img, str(people[label]),  (20,20), cv.FONT_HERSHEY_COMPLEX, 1.0, (0,255,0), thickness=4)
